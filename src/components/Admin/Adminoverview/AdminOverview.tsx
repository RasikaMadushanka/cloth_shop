...
function AdminOverview() {
    const salesData = [
        ...
        { day: "Wed", height: "30%" }, { day: "Thu", height: "75%" },
        { day: "Fri", height: "50%" }, { day: "Sat", height: "90%" },
        { day: "Sun", height: "70%" }
    ];
    const lowStock = [
        ...
        <div className="right_panel">
            <div className="overview_card">
                <div className="overview_card_header">
                    <h4>Saless Overview</h4><span className="uelv_link">Uelv ID <MdKeyboardArrowRight /></span>
                </div>
                <div className="bar_chart">{salesData.map((item, i) => (
